Attribute VB_Name = "mdlFilterWithPaintOption3"
Public Function fncBW() As Long
intBW = intColorToFilter / 3
fncBW = RGB(intBW, intBW, intBW)
End Function

Public Sub rtnFilterWithPaintOption3()
...
'Then  greyscale paint it to the screen
.picMain.PSet (intPxlX, intPxlY), fncBW()
