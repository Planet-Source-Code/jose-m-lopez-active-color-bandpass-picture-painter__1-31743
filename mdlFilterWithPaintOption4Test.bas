...
'***************************************************************
'*Summary Option 3 Black And White Plus One Or More RGB Colors**
'***************************************************************
...
'We greyscale paint adding one or more RGB colors
...
'greyscale painted adding one or more RGB colors.
...
'Greyscale Paint it and add one RGB color
GoSub lblTest:
...
Exit Sub
lblTest:
'.picMain.PSet (intPxlX, intPxlY), RGB(intBW + (rDiff * rOnOff), intBW + (gDiff * gOnOff), intBW + (bDiff * bOnOff))
.picMain.PSet (intPxlX, intPxlY), RGB(intBW, intBW, intBW)
Return
